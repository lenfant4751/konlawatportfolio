...
const Education = () => {
  ...
  const software = [
    ...
    { name: "EasyEDA", category: "PCB Design" },
  ...
  return (
    <section id="education" className="py-20 px-4 bg-space-darker/30">
      <div className="container max-w-6xl">
        ...
        <div className="space-y-6 mb-20">
          {education.map((edu, index) => (
            <Card 
              key={index}
              className="glass-card p-6 md:p-8 hover:glow-blue hover-lift"
            >

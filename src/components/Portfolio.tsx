...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      tech: ["Fusion360", "C/C++", "Python", "ANSYS"],
      image: "rov",
    },
  ];
  ...
  return (
    <section id="portfolio" className="py-20 px-4 bg-space-darker/50">
      <div className="container max-w-6xl">
            ...
            <Button
              ...
              className={
                activeFilter === filter.id
                  ...
                  : "glass-card border-border hover:border-primary hover:glow-blue"
              }
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {filteredProjects.map((project, index) => (
            <Card 
              key={project.id}
              className="glass-card overflow-hidden hover:glow-blue hover-lift group"
              style={{ animationDelay: `${index * 100}ms` }}
            >
              {/* Project image placeholder */}
              <div className="h-48 bg-gradient-to-br from-primary/20 to-accent/20 relative overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-6xl font-display text-primary/20">{project.image.toUpperCase()}</div>
                </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <Button 
                  variant="outline" 
                  className="w-full glass-card border-primary/50 hover:border-primary hover:glow-blue"
                >
